...
executeOnce ((Int n2):(Int n1):stack, e, (ADD):c, d, store)
    = ((Int (n1+n2)):stack, e, c, d, store)

executeOnce ((Int n2):(Int n1):stack, e, (SUB):c, d, store)
    = ((Int (n1-n2)):stack, e, c, d, store)

executeOnce ((Int n2):(Int n1):stack, e, (MUL):c, d, store)
    = ((Int (n1*n2)):stack, e, c, d, store)

executeOnce ((Int n2):(Int n1):stack, e, (DIV):c, d, store)
...
executeOnce ((Int n):stack, e, (SEL c1 c2):c, d, store)
    = if n == 0 then (stack, e, c1, ([], [], c):d, store) else (stack, e, c2, ([], [], c):d, store) 
